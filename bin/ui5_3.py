...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnshow = QtWidgets.QPushButton(qtawesome.icon('fa.newspaper-o', color='white'), "数据统计")
        self.btnshow.setObjectName('left_button')
        ...
        self.left_layout.addWidget(self.btnshow, 12, 0, 1, 3)
        self.left_layout.addWidget(self.btnback, 14, 0, 1, 3)
        ...
        self.btnshow.clicked.connect(MainWindow.btnShow_Clicked)
